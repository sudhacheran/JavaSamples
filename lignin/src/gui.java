...
public class gui extends JFrame {
    public gui() {
        JLabel label = new JLabel("Monomer Type:");;
        JTextField textField = new JTextField();
        JCheckBox caseCheckBox = new JCheckBox("G Type");
        JCheckBox wrapCheckBox = new JCheckBox("S Type");
        JCheckBox wholeCheckBox = new JCheckBox("H Type");
